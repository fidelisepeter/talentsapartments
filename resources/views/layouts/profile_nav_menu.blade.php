              ...
              <a class="nav-link  " href="/profile">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="/rentals">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg class="text-dark" width="12px" height="12px" viewBox="0 0 42 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          ...
                          <g stroke="none" stroke-width="1" fill="#fff" fill-rule="evenodd">
                            <g transform="translate(-1869.000000, -741.000000)" fill="#fff" fill-rule="nonzero">
                              <g transform="translate(1716.000000, 291.000000)">
                      ...
                      <span class="nav-link-text ms-1">My rentals </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link  @if (request()->is('booking_view*')) active @endif" href="/services">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
@if (\App\Models\BedSpace::where('id', DB::table('rents')->where('id',  Auth::user()->current_rent)->value('bed_space'))->first() && DB::table('rents')->where('id',  Auth::user()->current_rent)->value('status') == 'Approved')
                    ...
                    <a class="nav-link  " href="/room">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          ...
                          <g stroke="none" stroke-width="1" fill="#fff" fill-rule="evenodd">
                            <g transform="translate(-1720.000000, -592.000000)" fill="#fff" fill-rule="nonzero">
                              <g transform="translate(1716.000000, 291.000000)">
                      ...
                      <span class="nav-link-text ms-1">My Room/Bed Space</span>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                      <a class="nav-link  " href="/upkeep">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>document</title>
                            <g stroke="none" stroke-width="1" fill="#fff" fill-rule="evenodd">
                              <g transform="translate(-1870.000000, -591.000000)" fill="#fff" fill-rule="nonzero">
                                <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <span class="nav-link-text ms-1">Up Keeps</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link  " href="/my-guest">
                          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="/referrals">
                            ...
                            <span class="nav-link-text ms-1">Referrals/Promo</span>
                        </a>
                      </li>
                    @endif
                    <li class="nav-item">
