<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white ps--active-y"
    id="sidenav-main">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column nav ms-4 ps-3 sub-menu">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link @if (request()->is('resident*')) active @endif" href="/residents">
                                <span class="sidenav-mini-icon"> <i class="fa fa-circle"></i>  </span>
                                <span class="sidenav-normal"> Residents </span>
                            </a>
                        </li> --}}
                        <li class="nav-item ">
