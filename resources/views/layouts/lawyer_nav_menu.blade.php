            ...
            <li class="nav-item">
              <a class="nav-link  " href="/profile">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link  " href="/assigned-documents">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Assigned</span>
                    </a>
                </li>
     
                  <li class="nav-item">
                      <a class="nav-link  " href="/document/list/users">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">User Docs</span>
                      </a>
                    </li>

                    <li class="nav-item">
                      <a class="nav-link  " href="/document/agreement-forms/users">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>document</title>
                            <g stroke="none" stroke-width="1" fill="#fff" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Agreement Forms</span>
                      </a>
                    </li>
