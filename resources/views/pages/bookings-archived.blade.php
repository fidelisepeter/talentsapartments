                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-xs font-weight-bold">
                                                {{ DB::table('rooms')->where('id', $rent->room_id)->value('name') }} </span>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @if (
                                                $rent->school_check_status != 'Approved' &&
                                                    $rent->payment_reference == null &&
                                                    $rent->guarantor_letter_photo == null &&
                                                    $rent->health_check_photo == null &&
                                                    $rent->attestation_letter_photo == null)
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-danger w-10" role="progressbar"
                                            ...
                                            @elseif (
                                                ...
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-info w-20" role="progressbar"
