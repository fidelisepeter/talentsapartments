    ...
    <div class="row mt-3" id="f-row">
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-3">
                    <form action="/document/store" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="file" class="form-control mb-3" name="file" id="myPdf" required>
                        <label class="">File title</label>
                        <input class="form-control" type="text" name="title" onfocus="focused(this)"
                            onfocusout="defocused(this)" id="" required>
                        <label class="">Type of file</label>
                        <select class="form-control" name="type" id="type" required>
                           
                            <option value="site_document">
                                Site Document
                            </option>
                                <option value="agreement_form">
                                    Agreement Form
                                </option>
                        ...
                        {{-- <input class="form-control" type="text" name="type" onfocus="focused(this)"
                            onfocusout="defocused(this)" id="" required> --}}
                            ...
                            <li class="list-group-item border-0 px-0">
                                ...
                                <div class="d-none">
                                    ...
                                    <textarea id="signature_config" name="signature_config" class="multisteps-form__textarea text-xxs form-control"
                                        style="line-height: 1.4;" rows="5" placeholder="eg. [{page:1,x:30,y:200},{page:7,x:167,y:200}]." disabled></textarea>
                                </div>
                            </li>
                            <li class="list-group-item border-0 px-0">
                                <div class="form-check form-switch ps-0">
                        ...
                        <ul class="list-group">
                            ...
                            <textarea id="description" name="description" class="multisteps-form__textarea text-xxs form-control"
                                style="line-height: 1.4;" rows="5" placeholder="eg. [{page:1,x:30,y:200},{page:7,x:167,y:200}]."></textarea>
                        </ul>
                        <div class="d-flex justify-content-end mt-4">
                            <a href="/documents" class="btn btn-light m-0">Cancel</a>
                            <button type="submit" name="button" class="btn bg-gradient-primary m-0 ms-2">Upload
                                Document</button>
                        </div>
                    </form>
        ...
        <div class="col-12 col-md-6 col-xl-8 mt-md-0 mt-4">
            {{-- <div class="card">
                ...
                <div class="card-header pb-0" id="exclude-in-fullscreen-mode">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">PREVIEW
                                <span class="text-xs mb-0" id="coords"> </span>
                            </h5>
                        ...
                        <div class="ms-auto my-auto mt-lg-0">
                            <div class="ms-auto my-auto">
                                ...
                                <button class="btn bg-gradient-primary btn-sm export mb-0 mt-sm-0 mt-1"
                                    id="full-screen-button" type="button" name="button">Use Full Screen</button>
                                <button class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1 d-none"
                                    id="remove-full-screen-button" type="button" name="button">Use Normal
                                    Screen</button>
                ...
                <div class="card-body">
                    <div id="hide-preview-text">
                        <p class="description text-xs m-0">If you want to update a given position using the preview panel make
                        ...
                        <p class="discription text-xs m-0"><span class="text-danger">Note</span> The preview panel only
                    ...
                    <div id="divid">
                        <div class="row">
                            <div class="col-sm-3">
                                <label class="" id="hide-page-number-text">Select Page Number</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text btn bg-gradient-light" id="prev-page" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;">
                                            <i class="fa fa-arrow-down"></i>
                                        </span>
                                    </div>
                                    <input class="form-control px-3" name="page_number" type="number" id="page_number"
                                    value="1"  style="border-radius: 0px !important;" onfocus="focused(this)" onfocusout="defocused(this)">
                                    <div class="input-group-append">
                                       
                                            <span class="input-group-text btn bg-gradient-light" id="next-page" style="border-top-left-radius: 0px; border-bottom-left-radius: 0px;
                    "><i class="fa fa-arrow-up"></i> </span>
                            ...
                            <div class="col-sm-3">
                                <label class="" id="hide-x-text">X</label>
                                <input class="form-control" type="text" value="0" onfocus="focused(this)"
                                    onfocusout="defocused(this)" id="get-x">
                            </div>
                            <div class="col-sm-3">
                                <label class="" id="hide-y-text">Y</label>
                                <input class="form-control" type="text" value="0" onfocus="focused(this)"
                                    onfocusout="defocused(this)" id="get-y">
                            </div>
                            <div class="col-sm-3">
                                <label class="" id="hide-append-text">Append Value</label>
                                <select class="multisteps-form__select form-control" id="append-button" name="append">
                                    <option disabled selected>Append To:</option>
                        ...
                        <div id="work-space" style="max-width:446.25px; min-height:631.75px" class="mt-1 position-relative">
                            <span id="cursor" class="position-absolute" style="border-style: none none solid solid;border-width: 0px 0px 1px 1px;height: 15px;border-color: red;width: 15px;"></span>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $("#myPdf").on("change", function(e) {
            preview('myPdf', 1, 'page_number');
        });

        $("#page_number").on("change", function(e) {
            // alert(JSON.stringify(this.value))
            var page = this.value
            preview('myPdf', Number(page), 'page_number');
        });
        ...
        function preview(id, pageNumber = 1, incre_id) {
            // var file = i.files[0]
    ...
    <script type="text/javascript">
        ...
        */
        ...
        $('#pdfViewer').mousemove(function(event) {
            ...
            $("#cursor").css('top', y_coordinate-2.3);
