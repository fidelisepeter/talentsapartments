...
@endif
@section('page-title', 'Users Agreement Forms')
@section('content')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header pb-0">
          <div class="d-lg-flex">
              <div>
                  <h5 class="mb-0">Agreement Forms</h5>
            ...
            <table id="user-table"  class="table align-items-center mb-0">
                ...
                <tbody>
                    ...
                    @php
                        ...
                        $count_of_pending_documents = ($count_of_user_documents-$count_of_completed_documents);

                        
                    @endphp
                    @if ($count_of_user_documents != 0)
                        ...
                        <td>
                            <div class="d-flex px-2 py-1">
                              ...
                              <div class="d-flex flex-column justify-content-center">
                                <a href="/document/agreement-forms/users/{{ $resident->user->id ?? ''}}">
                          ...
                          <td>
                            <p class="text-sm text-secondary mb-0">{{ $count_of_user_documents }}</p>
                          </td>
                        <td>
