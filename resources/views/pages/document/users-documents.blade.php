...
@endif
@php
$page_title = $user->first_name . ' ' . $user->middle_name . ' ' . $user->last_name . ' Documents';
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    @if ($document->signed()->where('user_id', $user->id)->first() == null)
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    @endphp
                    @if ($document->signed()->where('user_id', $user->id)->where('signatures_status', 'completed')->where('stamps_status', 'completed')->where('names_status', 'completed')->first())
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
