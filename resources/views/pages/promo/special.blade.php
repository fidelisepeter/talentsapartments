                ...
                <div class="card-body ">
                    <form class="form-horizontal" method="POST" action="/create-promo" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input id="" type="hidden" class="form-control" name="promo_type" value="special"
                                required="">
                        ...
                        <div class="form-group">
                            <select id="room_id" class="form-control" name="room_id" required="">
                                @foreach (DB::table('rooms')->get() as $room_type)
                                    <option data-price="{{ $room_type->price }}" value="{{ $room_type->id }}">
                        ...
                        <div class="form-group">
                            <input id="percentage_off" type="number" max="100" min="0" class="form-control"
                                name="percentage_off" value="20" required="">
