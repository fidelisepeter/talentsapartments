            ...
            <form action="/profile/update-settings" method="POST" enctype="multipart/form-data" id="profile-form">
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label class="form-label mt-4">office Phone</label>
                                <div class="input-group">
                                    <input id="office_phone" name="office_phone" class="form-control" type="number"
                                        value="{{ Auth::user()->office_phone ?? '' }}">
                                </div>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inscription" name="inscription" type="text"
                                    placeholder="Enter something" value="{{ Auth::user()->inscription ?? '' }}" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label mt-4">Note </label>
                                <input class="form-control" id="note" name="note" type="text"
                                    value="{{ Auth::user()->note ?? '' }}" placeholder="Enter something" />
                            </div>
                            <div class="row">

                                <div class="col-md-12">
                                    <label class="form-label mt-4">Note 2</label>
                                    {{-- <small class="text-grey opacity-7">Note will be attach the email sent to the
                                    user</small> --}}
                                    <textarea class="multisteps-form__textarea form-control" rows="5" name="note_1" placeholder="">{{ Auth::user()->note_1 ?? '' }}</textarea>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-4">
                                    <label class="form-label mt-4">Signature</label>
                                    <div class="input-group">
                                        <input id="signature" name="signature" class="form-control" type="file"
                                            placeholder="">
                                        <span id="signature-response">
                                        </span>
                                    </div>

                                </div>
                                <div class="col-4">
                                    <label class="form-label mt-4">Stamp</label>
                                    <div class="input-group">
                                        <input id="stamp" name="stamp" class="form-control" type="file"
                                            placeholder="">
                                        <span id="stamp-response">
                                        </span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button class="btn bg-gradient-dark btn-sm float-end mt-6 mb-0" id="profile-form-submit" type="button">Update
                                        Settings</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <form action="/profile/settings/new_document_email_notification" method="post">
                                                @csrf
                                                <input class="form-check-input" type="checkbox" name="new_document_email_notification"
                                                id="flexSwitchCheckDefault11" onchange="this.form.submit()" @if (Auth::user()->lawyer->new_document_email_notification == true)
                                                    checked
                                                @endif>
                                            </form>
                                        </div>
                    ...
                    @foreach (DB::table('login_details')->where('user_id', Auth::id())->limit(5)->get() as $logins)
                        ...
                        <div class="d-flex align-items-center">
                            <div class="text-center w-5">
                                @if (strpos($logins->browser, 'mobile'))
                                    <i class="fas fa-mobile text-lg opacity-6"></i>
                                @else
                                    <i class="fas fa-desktop text-lg opacity-6"></i>
                                @endif
