...
@section('style')
@endsection
@section('page-title', 'Create Lawyer')
@section('content')
            ...
            <div class="multisteps-form mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <form class="multisteps-form__form mb-8" id="create-lawyer-form" action="/lawyer/save" method="POST">
                            @csrf
                            <!--single form panel-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <textarea class="multisteps-form__textarea form-control" rows="5" name="note"
                                                placeholder="send lawyer a message. you can add lawyer password."></textarea>
                                        </div>
                                    </div>
                                    <div class="button-row d-flex mt-4">
                                        <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                        ...
                                        <button class="btn bg-gradient-dark ms-auto mb-0" type="button" title="Send"
                                            id="create-lawyer-button">Send</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        $(document).ready(function() {
            ...
            $("#create-lawyer-button").click(function() {
                ...
                if (!$("input[name='first_name']").val()) {
                    message.push({
                        type: 'required',
                        message: 'Lawyer first name is required',
                    });
                }
                ...
                if (!$("input[name='last_name']").val()) {
                    message.push({
                        type: 'required',
                        message: 'Lawyer last name is required',
                    });
                }
