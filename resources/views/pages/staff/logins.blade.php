...
@endif
@section('page-title', $staff->first_name . ' ' . $staff->last_name . ' - Login Reports')
@section('content')
            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table id="staff-logins" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Staff
                                        Location
                                    </th>
                            ...
                            <tbody>
                                @foreach ($logins as $user)
                                    ...
                                    @endphp
                                    @if (DB::table('users')->where('id', $staff->id)->value('role') != 'student')
                                        <tr>
                                            <td>
                                                <a href="#">
...
@section('script')
    ...
    <script>
        if (document.getElementById('staff-logins')) {
            const dataTableSearch = new simpleDatatables.DataTable("#staff-logins", {
                searchable: true,
                fixedHeight: false,
                perPage: 10,
                paging: true,
            ...
            document.querySelectorAll(".export").forEach(function(el) {
                el.addEventListener("click", function(e) {
                    ...
                    var data = {
                        type: type,
                        filename: "{{ $staff->first_name . '-' . $staff->last_name }}-login-report" +
                            type,
                    };
