...
@endif
@section('page-title', 'Edit Staff - '. $staff->first_name. ' '. $staff->last_name)
@section('content')
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-auto col-4">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ $staff->photo ?? asset('assets/img/no-pics-placeholder.jpg') }}"
            ...
            <!-- Card Basic Info -->
            <form action="/staff/{{ $staff->id }}/update-details" method="POST" enctype="multipart/form-data" id="profile-form">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="first_name" name="first_name" class="form-control" type="text"
                                        value="{{ $staff->first_name ?? '' }}" required="required">
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="last_name" name="last_name" class="form-control" type="text"
                                        value="{{ $staff->last_name ?? '' }}" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <form action="/staff/{{ $staff->id }}/update-password" method="POST">
                @csrf
        ...
        $(document).ready(function() {
            ...
            if (inject_browser_data) {
                var biometricsStatus = {
                    user: '{{ Auth::id() }}',
                    email: '{{ $staff->email }}',
                    image: '{{ $staff->photo ?? asset('assets/img/no-pics-placeholder.jpg') }}',
