                        ...
                        <div class="col-sm-4">
                            @if (Auth::user()->role != 'student')
                                @if ($rent->proof_status == 'Approved')
                                    ...
                                    <a href="/send_guarantor_form/{{ $user_id }}" class="btn btn-warning btn-sm"
                                        >send form to
                                        guarantor</a>
                            ...
                            @else
                                ...
                                @else
                                <div class="text-info">
                                    The form has been sent to your guarantor email ({{ DB::table('users')->where('id', $user_id)->value('g_email') }})
                                </div>
                                <div class="text-dark">
                                    Fill the form and submit here
                                </div>
                                <form class="" action="/booking_step" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <input type="file" required class="form-control mb-3" name="photo"
                                            id="">
                                        <button class="btn btn-info" type="submit">Re-Upload form</button>
                                    </form>
                                @endif
                            @endif
                        </div>
