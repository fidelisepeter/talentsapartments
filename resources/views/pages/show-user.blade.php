...
@section('page-title', $user->first_name . ' ' . $user->middle_name . ' ' . $user->last_name)
...
@section('content')
    <div class="row mb-5">
        <div class="col-lg-3">
            <div class="card position-sticky top-1">
                <ul class="nav flex-column bg-white border-radius-lg p-3">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll="" href="/resident/{{ $user->id }}/guest">
                            <div class="icon me-2">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll="" href="/resident/{{ $user->id }}/invoices">
                            <div class="icon me-2">
                    ...
                    @if (Auth::user()->role == 'super_admin' || Auth::user()->role == 'admin' || Auth::user()->role == 'staff')
                        <li class="nav-item pt-2">
                            <a class="nav-link text-body" data-scroll="" href="#booking-history">
                                <div class="icon me-2">
        ...
        <div class="col-lg-9 mt-lg-0 mt-4">
            ...
            <form action="/update-resident/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-sm-auto col-8 my-auto">
                            <div class="h-100">
                                ...
                                <p class="mb-0 font-weight-bold text-sm">
                                    {{ ucwords($user->role) }} - {{ $user->ta_uid }}
                                    {{-- <p class="text-xs font-weight-bold mb-0">{{ $building_name }},
                                    {{ $room_label }}</p>
                                <p class="text-xs text-secondary mb-0">{{ $room_number }},
                                    {{ $room->name }}, {{ $name }}</p>
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="first_name" name="first_name" class="form-control" type="text"
                                        value="{{ $user->first_name }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="last_name" name="middle_name" class="form-control" type="text"
                                        value="{{ $user->middle_name }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="last_name" name="last_name" class="form-control" type="text"
                                        value="{{ $user->last_name }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-sm-flex bg-gray-100 border-radius-lg">
                                    ...
                                    <input class="form-control form-control-sm ms-sm-auto mt-sm-0 mt-2 w-sm-15 w-50"
                                        type="text" value="{{ $user->verification_code }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="email" name="email" class="form-control" type="email"
                                        value="{{ $user->email }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="phone_number" name="phone_number" class="form-control" type="number"
                                        value="{{ $user->phone_number }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="street" name="street" class="form-control" type="text"
                                        value="{{ $user->street }}" onfocus=" focused(this)"
                                        onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="city" name="city" class="form-control" type="text"
                                        value="{{ $user->city }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <img class="w-50 m-5 img-thumbnail"
                                    src="{{ $user->photo ?? asset('assets/img/no-pics-placeholder.jpg') }}"
                                    alt="logo_slack">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <input value="{{ $user->school }}" type="text" class="form-control" name="school">

                            </div>
                            <div class="col-sm-3">
                                <label class="form-label mt-0">Level</label>

                                <input value="{{ $user->level }}" type="text" class="form-control" name="level">

                            </div>
                            <div class="col-sm-4">
                                <label class="form-label mt-0">Course</label>

                                <input value="{{ $user->course }}" type="text" class="form-control" name="course">

                            </div>
                            <div class="col-sm-4">
                                <label class="form-label mt-4">Depertment</label>
                                <input value="{{ $user->department }}" type="text" class="form-control"
                                    name="department">

                            </div>
                            <div class="col-sm-4">
                                <label class="form-label mt-4">Faculty</label>
                                <input value="{{ $user->faculty }}" type="text" class="form-control" name="faculty">

                            </div>
                            <div class="col-sm-4">
                                <label class="form-label mt-4">Matric Number</label>
                                <input value="{{ $user->matric_number }}" type="text" class="form-control"
                                    name="matric_number">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <select class="form-control" name="g_suffix" id="">
                                        <option>--Title--</option>
                                        <option value="Mr" @if ($user->g_suffix == 'Mr') selected @endif>Mr
                                        </option>
                                        <option value="Mrs" @if ($user->g_suffix == 'Mrs') selected @endif>Mrs
                                        </option>
                                        <option value="Prof" @if ($user->g_suffix == 'Prof') selected @endif>Prof
                                        </option>
                                        <option value="Doc" @if ($user->g_suffix == 'Doc') selected @endif>Doc
                                        </option>
                                        <option value="Engr" @if ($user->g_suffix == 'Engr') selected @endif>Engr
                                        </option>
                                        <option value="Alh" @if ($user->g_suffix == 'Alh') selected @endif>Alh
                                        </option>
                                        <option value="Alj" @if ($user->g_suffix == 'Alj') selected @endif>Alj
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control" name="g_relationship" id="">
                                        ...
                                        <option value="Father" @if ($user->g_relationship == 'Father') selected @endif>Father
                                        </option>
                                        <option value="Mother" @if ($user->g_relationship == 'Mother') selected @endif>Mother
                                        </option>
                                        <option value="Brother" @if ($user->g_relationship == 'Brother') selected @endif>Brother
                                        </option>
                                        <option value="Sister" @if ($user->g_relationship == 'Sister') selected @endif>Sister
                                        </option>
                                        <option value="Uncle" @if ($user->g_relationship == 'Uncle') selected @endif>Uncle
                                        </option>
                                        <option value="Aunty" @if ($user->g_relationship == 'Aunty') selected @endif>Aunty
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="g_email" name="g_email" class="form-control" type="email"
                                        value="{{ $user->g_email }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-6">
                                <label class="form-label mt-4">Phone Number</label>
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="g_street" name="g_street" class="form-control" type="text"
                                        value="{{ $user->g_street }}" onfocus=" focused(this)"
                                        onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="g_city" name="g_city" class="form-control" type="text"
                                        value="{{ $user->g_city }}" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-4">
                                <label class="form-label mt-4">State</label>
            ...
            <div class="card mt-4" id="booking-history">
                <div class="card-header">
                                ...
                                @foreach ($rents as $rent)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ \Carbon\Carbon::parse($rent->move_in)->format('M j, Y') }}</span>
                                        </td>

                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ \Carbon\Carbon::parse($rent->expiring_date)->format('M j, Y') }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold"> {{ $rent->status }} </span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ \Carbon\Carbon::parse($rent->move_in)->format('M j, Y') }}</span>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="my-auto ms-3">
                                <div class="h-100">
                                    ...
                                    <a href="/document/print/{{ $agreement_form->id }}/user/{{ $user->id }}"
                                        class="mb-0 text-sm text-primary">view document</a>
                                </div>
                            </div>

                            <p class="text-sm text-secondary ms-auto me-3 my-auto">
                                @if ($agreement_form->consent()->where('user_id', $user->id)->first() != null)
                                    Accepted
                                @else
                                    Awaiting Acceptance
                                @endif
                ...
                <div class="card mt-4" id="delete">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex">
                            ...
                            @if (DB::table('users')->where('id', $user->id)->value('disable_login') == true)
                                <p class="text-secondary text-sm ms-auto my-auto me-3">Disabled</p>

                                <form action="/enable-resident/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                            ...
                            @else
                                ...
                                <form action="/disable-resident/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" onchange="this.form.submit()"
                                            checked>
                                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            {{-- <button class="btn btn-sm btn-outline-dark mb-0" type="button">Add</button> --}}
                            @if (DB::table('users')->where('id', $user->id)->value('disable_picture_update') == true)
                                <p class="text-secondary text-sm ms-auto my-auto me-3">Disabled</p>

                                <form action="/allow-change-profile-picture/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" onchange="this.form.submit()">
                                    </div>
                                </form>
                            @else
                                <p class="text-secondary text-sm ms-auto my-auto me-3">Enabled</p>
                                <form action="/disallow-change-profile-picture/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" onchange="this.form.submit()"
                                            checked>
                                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            {{-- <button class="btn btn-sm btn-outline-dark mb-0" type="button">Add</button> --}}
                            @if (DB::table('users')->where('id', $user->id)->value('disable_guest') == true)
                                <p class="text-secondary text-sm ms-auto my-auto me-3">Disabled</p>

                                <form action="/enable-guest/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" onchange="this.form.submit()">
                                    </div>
                                </form>
                            @else
                                <p class="text-secondary text-sm ms-auto my-auto me-3">Enabled</p>
                                <form action="/disable-guest/{{ $user->id }}">
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" onchange="this.form.submit()"
                                            checked>
                                    </div>
                        ...
                        @if (DB::table('users')->where('id', $user->id)->value('disable_guest') != true)
                            <form action="/update-max-guest-per-day/{{ $user->id }}">
                                <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                                    ...
                                    <input
                                        ...
                                        value="{{ DB::table('users')->where('id', $user->id)->value('max_guest_per_day') ?? DB::table('settings')->value('global_max_guest_per_day') }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (get_country_index && state) {
                print_state('state', get_country_index, '{{ $user->state ?? '' }}')
            }
            //Make default country & state selected
            var g_state = '{{ $user->g_state ?? '' }}';
            print_country("country", "Nigeria")
            var get_country_index = $("#country")[0].selectedIndex
            if (get_country_index && g_state) {
                print_state('g_state', get_country_index, '{{ $user->g_state ?? '' }}')
            }
