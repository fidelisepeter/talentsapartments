...
<head>
    ...
    <title> @yield('page-title') - Talents Apartments</title>
...
<body class="yellow-skin">
                ...
                <nav id="navigation" class="navigation navigation-landscape">
                    <div class="nav-header">
                        <a class="nav-brand" href="/">
                            <img src="{{ asset('home-page-assets/img/ta-logo.png') }}" class="logo" alt="" />
                        </a>
                        <div class="nav-toggle"></div>
                        <div class="mobile_nav">
                            <ul class="">
                                <li class="add-listing"><a href="/login" class="theme-cl"><i class="bi bi-box-arrow-in-right pr-2"></i>Dashboard</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="nav-menus-wrapper" style="transition-property: none;">
                        ...
                        <ul class="nav-menu nav-menu-social align-to-right">
                            ...
                            <li><a href="/login"><i class="bi bi-box-arrow-in-right pr-2"></i>Dashboard</a></li>
                            <li class="add-listing">
                                <div class="dropdown">
                                    <a href="" class=" theme-cl">
                                        Book Now<i class="bi bi-caret-down-fill pr-2"></i>
                                    </a>
                                    <div class="dropdown-content rounded" id="dropbtn-link">
                                        <a style="color:black !important;"
                                            href="https://api.whatsapp.com/send/?phone=2348105446372&text&type=phone_number&app_absent=0"><i
                                                class="bi bi-whatsapp pr-2"></i>Whatsapp</a>
                                        <a style="color:black !important;" href="#" data-toggle="modal"
                                            data-target="#autho-message"><i class="bi bi-telephone pr-2"></i>Call Me</a>
                                        <a style="color:black !important;"
                                            href="mailto:reservations@talentsapartments.com"><i
                                                class="bi bi-envelope pr-2"></i>Email</a>
                                        <a style="color:black !important;" href="/login"><i
                                                class="bi bi-caret-down-fill pr-2"></i>Book</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="footer_widget">
                                <img src="./assets/img/ta-logo.png" class="img-footer small mb-2" alt="" />
                ...
                <div class="modal-content overli" id="registermodal">
                    <div class="modal-body p-0">
                        <div class="resp_log_wrap">
                            <div class="resp_log_thumb" style="background:url(./img/log.jpg)no-repeat;">
                            </div>
                                        ...
                                        <div class="login-form">
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <div class="eltio_ol9">
                                                        <div class="eltio_k1">
                                                            <input id="dds" class="checkbox-custom"
                                                                name="dds" type="checkbox">
                                                            <label for="dds" class="checkbox-custom-label">By
                                                                using the
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    {{-- {{ asset('home-page-assets/img/ta-logo.png') } --}}
