<?php $page_title_name = 'Registration'; ?>
                                        ...
                                        <div class="resp_log_caption">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="pills-signup-tab" data-toggle=""
                                                            ...
                                                            aria-controls="pills-signup" aria-selected="false"><i
                                                                class="fas fa-user-plus mr-2"></i>Login</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="pills-login-tab"
                                                            ...
                                                            aria-controls="pills-login" aria-selected="true"><i
                                                                class="fas fa-sign-in-alt mr-2"></i>Register</a>
                                                    </li>
                                            ...
                                            <div class="login-form">
                                                <form method="POST" action="/application_setup">
                                                    ...
                                                    @if (DB::table('settings')->value('referral') &&
                                                        DB::table('settings')->value('referral_expiring_date') > \Carbon\Carbon::now())
                                                        ...
                                                        <div class="form-group">
                                                            <div class="eltio_ol9">
                                                                <div class="eltio_k1">
                                                                    <input id="referral-code-action"
                                                                        class="checkbox-custom" type="checkbox"
                                                                        @if (request('ref') != null) checked @endif>
                                                                    <label for="referral-code-action"
                                                                        class="checkbox-custom-label"> I have a referral
                                                                        code</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="eltio_ol9">
                                                            <div class="eltio_k1">
                                                                <input id="dds" class="checkbox-custom"
                                                                    name="dds" type="checkbox" checked="" required>
                                                                <label for="dds" class="checkbox-custom-label">By
                                                                    using the
                                                                    website, you accept the terms and
                                                                    conditions</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p class=" mx-auto text-dark text-center">
                                                        ...
                                                        <a href="./login" class="text-dark text-gradient font-weight-bold">Sign
                                                            in</a>
                                                    </p>
                                                </form>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 pt-5">
                    ...
                    <div class="call_action_wrap mt-5">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="login-form">
                            <form>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-md full-width pop-login">Call Me Back</button>
                                </div>
